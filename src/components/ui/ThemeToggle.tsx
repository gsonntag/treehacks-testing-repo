...
export function ThemeToggle({ showLabel = false, size = "md" }: ThemeToggleProps) {
  ...
  const translateXHalf = size === "sm" ? "translate-x-3" : "translate-x-3.5";
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        <div
          className={`${knobSize} rounded-full flex items-center justify-center transition-transform duration-300 ${getKnobPosition()}`}
